...
import { CargaFamiliar } from "./modalCargaFamiliar";

export const ModalFuneraria = (props) => {
    ...
    const [mostrar10, setMostrar10] = useState(false);
        ...
        >
            <Modal.Header className="bg-azul">
                <Modal.Title style={{ color: "#fff" }}>
                    <Modal.Title style={{ color: "#fff" }}>
                        {operacion === 1
                            ? "Registro Contrato Funeraria."
                            : operacion === 2
                                ? "Editar Contrato Funeraria."
                                : operacion === 3
                                    ? "Renovar Contrato Funeraria."
                                    : "Registro Contrato Funeraria."}
                    </Modal.Title>{" "}
                </Modal.Title>
                <button
                    ...
                    >
                        ...
                        <div className="row col-12 d-flex justify-content-between mb-2">
                            ...
                            <div className="col-3 d-flex justify-content-end">
                                <button
                                    onClick={() => { setMostrar10(true); console.log('hola') }}
                                            ...
                                            <TableRow key={index} style={{ padding: "0" }}>
                                                ...
                                                >
                                                    <button
                                                        ...
                                                        onClick={() => elimminarrTipo(item.ced)}
                                                    >
